...
export const projectList: IProjectType[] = [
...

  {
    ...
    하지만 프로젝트를 진행하면서 PM 선생님의 조언과 선배님들의 도움으로 코드와 디자인의 통일이 맞춰지기 시작하였습니다.<br/>
    저번 프로젝트에서는 CRUD를 익혔다면, 이번 프로젝트에서는 React.js 컴포넌트 재활용성 및 코드의 질을 훨씬 끌어올릴 수 있었고,<br/>
    제가 팀장을 맡았던 프로젝트 였기에, 팀장의 높은 책임감과 팀을 이끄는 리더쉽이 정말 중요하다는 것을 깨닫게 되었습니다.<br/>
    그리고 우여곡절 끝에 프로젝트를 완성하였고 이후 학사일정 기능을 업그레이드 하는 과정이 있었는데, <br/>
...

  {
    ...
    전 세계별, 국내 감염자의 수의 데이터를 시각화 하여 현재 감염자 수를 한눈에 알아볼수 있고,<br />
    지역 공유 게시판, 동네 가게 홍보 등 커뮤니티 기능을 이용한 사람들과의 협력을 통하여 대화할 수 있도록 하였습니다.<br/>
