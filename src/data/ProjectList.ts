...
import DeepFlowComment from 'assets/images/mockup/DeepFlow/Comment.png';
import DeepFlowHome from 'assets/images/mockup/DeepFlow/Home.png';
import DeepFlowPosts from 'assets/images/mockup/DeepFlow/Posts.png';
import DeepFlowTag from 'assets/images/mockup/DeepFlow/Tag.png';
import DeepFlowTagPost from 'assets/images/mockup/DeepFlow/TagPost.png';
import DeepFlowUser from 'assets/images/mockup/DeepFlow/User.png';
import DeepFlowWrite from 'assets/images/mockup/DeepFlow/Write.png';
...
const projectList: IProject[] = [
  {
    ...
    description: `
      기숙학교를 지내는 학생들은 교과시간이 끝난 이후에는 학교 안에서 자유롭게 자습을 할 수 있습니다.
    ...
    link: `<a style ='color: ${palette.blue}' href='http://dodam.b1nd.com' target='_blank' rel ='noopener noreferrer'>
...

  {
    ...
    link: `<a style ='color: ${palette.blue}' href='http://admin.dodam.b1nd.com' target='_blank' rel ='noopener noreferrer'>
...

  {
    ...
    link: `<a style ='color: ${palette.blue}' href='http://teacher.dodam.b1nd.com' target='_blank' rel ='noopener noreferrer'>
...

  {
    ...
    feel: `
      처음으로 바인드팀과 관한 웹페이지를 만들어보는 일이었고, 그만큼 중요했던 프로젝트 였기에
    ...
    link: `<a style ='color: ${palette.blue}' href='http://b1nd.com' target='_blank' rel ='noopener noreferrer'>http://b1nd.com</a>`,
  },

  {
    ...
    link: `
      서비스가 종료되었습니다.<br />
      깃허브: <a style ='color: ${palette.blue}' href='https://github.com/yiyb0603/Here-Corona' target='_blank' rel ='noopener noreferrer'>
...

  {
    ...
    link: `
      깃허브: <a style ='color: ${palette.blue}' href='https://github.com/yiyb0603/2019_ICT' target='_blank' rel ='noopener noreferrer'>
...

  {
    ...
    `,
    role: '프론트엔드, 백엔드를 혼자서 제작하였습니다.<br/>',
    link: `
      프론트엔드 깃허브: <a style ='color: ${palette.blue}' href='https://github.com/yiyb0603/YLog_Web' target='_blank' rel ='noopener noreferrer'>
      https://github.com/yiyb0603/YLog_Web</a><br/>
      백엔드 깃허브: <a style ='color: ${palette.blue}' href='https://github.com/yiyb0603/YLog_Server' target='_blank' rel ='noopener noreferrer'>
...

  {
    ...
    link: `
      깃허브: <a style ='color: ${palette.blue}' href='https://github.com/yiyb0603/SchoolMeals_TS' target='_blank' rel ='noopener noreferrer'>
...

  {
    ...
    link: `
      깃허브: <a style ='color: ${palette.blue}' href='https://github.com/yiyb0603/Livro-Front-end' target='_blank' rel ='noopener noreferrer'>
...

  {
    ...
    link: `
      깃허브: <a style ='color: ${palette.blue}' href='https://github.com/yiyb0603/CoCode_Web' target='_blank' rel ='noopener noreferrer'>
...

  {
    ...
    `,
    link: `
      프론트엔드 깃허브: <a style ='color: ${palette.blue}' href='https://github.com/yiyb0603/Polypoid_Client' target='_blank' rel ='noopener noreferrer'>
      https://github.com/yiyb0603/Polypoid_Client</a><br/>
      백엔드 깃허브: <a style ='color: ${palette.blue}' href='https://github.com/yiyb0603/Polypoid_Server' target='_blank' rel ='noopener noreferrer'>
...

  {
    ...
    `,
    link: `
      깃허브: <a style='color: ${palette.blue}' href='https://github.com/yiyb0603/my_portfolio' target='_blank' rel ='noopener noreferrer'>
...

  {
    ...
    name: 'DeepFlow',
    type: ['Front-End', 'Back-End'],
    stacks: ['TypeScript', 'React.js', 'Scss', 'Recoil', 'Nest.js', 'TypeORM', 'PostgreSQL', 'FCM', 'Github OAuth'],
    period: '2021.03 ~ 06',
    introduction: '대구소프트웨어고등학교 교내 StackOverflow 서비스',
    thumbnail: DeepFlowHome,
    member: ALONE,
    gallery: [DeepFlowHome, DeepFlowUser, DeepFlowPosts, DeepFlowTag, DeepFlowTagPost, DeepFlowWrite, DeepFlowComment],
    description: `
      대구소프트웨어고등학교 학생들은 자신이 공부를 하다가 잘 모르는 정보 혹은 제대로 알고 싶은 전공 지식이 있다면
      검색을 통해서 알아보거나 혹은 오프라인이나 메신저를 이용하여 친구 또는 선배들에게 물어보고 정보를 얻을 수 있습니다. 
      하지만 자주 물어보러 다니는 것이 번거롭거나 상황이 애매하여 질문하기 어려울 때 등, 번거로운 상황을 없애고
      이를 온라인화 한 웹 서비스를 제공하기로 했습니다.
    `,
    role: '프론트엔드, 백엔드 모두 혼자서 제작했습니다.',
    feel: `
      1. Recoil 전역 상태관리 라이브러리를 사용한 첫번째 프로젝트인데 생각보다 어렵지 않았고, 리액트스러운 상태관리 라이브러리 였으며, 앞으로의
      프로젝트들에 많이 도입 할 것 같습니다.<br />

      2. 이전까지 Nest.js를 제대로 활용해본적이 거의 없었는데, 이번 프로젝트를 통해서 Nest.js내에서 제공하는 MVC 패턴을 능숙하게 사용할 수 있게
      되었습니다. 이 외에도 QueryBuilder 등 TypeORM의 좋은 기능들을 더 알게 되었습니다.<br />

      3. Chrome lighthouse를 이용한 웹 페이지 성능 체크 관리의 중요성을 알게 되었습니다.
    `,
    link: `
      프론트엔드 깃허브: <a style ='color: ${palette.blue}' href='https://github.com/yiyb0603/DeepFlow_Web' target='_blank' rel ='noopener noreferrer'>
      https://github.com/yiyb0603/DeepFlow_Web</a><br/>

      백엔드 깃허브: <a style ='color: ${palette.blue}' href='https://github.com/yiyb0603/DeepFlow_Server' target='_blank' rel ='noopener noreferrer'>
      https://github.com/yiyb0603/DeepFlow_Server</a>
    `,
  },
];
